...
class ProfileChangePasswordController: UIViewController{
    ...
    //Kontrolliert ob Passwordfelder ausgefüllt worden sind
    //Kontrolliert ob beiden neue Password auch gleich sind
    //Ruft UserService zum ändern des Passwords auf
