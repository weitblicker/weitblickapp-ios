...
class ResultMapViewController: UIViewController ,UITableViewDataSource, UITableViewDelegate  {
    ...
    //TableView zeigt Sponsoren des geradelten Projektes an
    //TableView Größe festlegen
    
      func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return (self.project?.getCycleObject.getDonations.count)!
      }
      //Sponsorendaten in Zelle richtig zuweisen
    ...
    override func viewDidLoad() {
        ...
        //Falls mehr als ein Host für das Projekt vorhanden diese als Liste darstellen
