...
class Project{
    ...
    init(id : Int,published : Date, name : String, gallery : [String], hosts : [String], description : String, locationID : Int, partnerID : [Int]){
        self.id = id
        self.published = published
        self.name = name
        self.gallery = gallery
        self.galleryCount = self.gallery.count
        self.hosts = hosts
