...
//                   }
       ...
       // else if(self.project_object!.getCycleObject.getDonations.count > 0){
            ...
            return sphead_cell
             ...
             let splist_cell = cell.sponsor_tableView.dequeueReusableCell(withIdentifier:"splist_cell", for: indexPath)as! SpListCell
                ...
                splist_cell.splist_sponsor.text = "SPonsor text ahjsvdkhasvfkhsvf"
                splist_cell.splist_description.text = "Description hbuhsbhhsvhcvchvhj"
       ...
       // else if (project_object!.getMilestones.count > 0){
            ...
            if (indexPath.row == 6){
              ...
              melist_cell.melist_date.text = "Datum"

                melist_cell.melist_headline.text = "headline"
                melist_cell.melist_description.text = "description"
