...
/*
 ...
 =============
    - getNewsByID:
        - Fetching EventObject Data with specified ID from REST API.
        - If no image exists for this dataset, a default image will be set.
        - Event text will be transformed into clean text. HTML tags will be removed as well as Image tags.
        - Function will return EventObject in Completionhandler.
    - loadEvents:
        - Fetching Eventobject datasets
        - If no image exists for a dataset, a default image will be set.
        - Function will return EventObjectlist in Completionhandler.
 */
